package TastCasePackageAdvance;
...
public class T002_Login_And_Purchase extends BaseDriver {
	...
	public void loginAndPurchase(String email, String password, String comment) {
		...
		AssertJUnit.assertEquals(signInpage.getTitle(), signInpage.signinPageTitle);
		...
		AssertJUnit.assertEquals(casualDressespage.getTitle(), casualDressespage.casualDressesPageTitle);
		...
		AssertJUnit.assertEquals(t_Shirtspage.getTitle(), t_Shirtspage.t_ShirtsPageTitle);
		...
		AssertJUnit.assertEquals(checkoutpage.getTitle(), checkoutpage.checkoutpageTitle);
